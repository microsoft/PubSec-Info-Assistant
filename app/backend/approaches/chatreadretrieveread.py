...
class ChatReadRetrieveReadApproach(Approach):
    ...
    async def run(self, history: Sequence[dict[str, str]], overrides: dict[str, Any]) -> Any:
        ...
        query_prompt=PromptStrings.QUERY_PROMPT_TEMPLATE.get(self.__class__.__name__, "Default query prompt").format(query_term_language=self.query_term_language)
        ...
        messages = self.get_messages_from_history(
            ...
            history,
            user_question,
            PromptStrings.QUERY_PROMPT_FEW_SHOTS.get(self.__class__.__name__, "Default query few shots"),
        ...
        if prompt_override is None:
            system_message = PromptStrings.SYSTEM_MESSAGE_CHAT_CONVERSATION.get(self.__class__.__name__, "Default system message").format(
        ...
        if self.model_name.startswith("gpt-35-turbo"):
            messages = self.get_messages_from_history(
                ...
                PromptStrings.RESPONSE_PROMPT_FEW_SHOTS.get(self.__class__.__name__, "Default response few shots"),
