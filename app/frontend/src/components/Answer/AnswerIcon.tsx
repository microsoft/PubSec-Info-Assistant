...
export const AnswerIcon: React.FC<AnswerIconProps> = ({ approach }) => {
    if (approach == Approaches.ChatWebRetrieveRead) {
        return <div className={styles.answerLogoWeb}><Globe24Filled primaryFill={"#147e3d"} aria-hidden="true" aria-label="Web Answer logo" /> Web</div>;
        }
        ...
        return <div className={styles.answerLogoCompare}><Globe24Filled primaryFill={"#a66224 "} aria-hidden="true" aria-label="Web Compared to Work Answer Logo" /><Link20Filled primaryFill={"#a66224 "} /><BuildingMultiple24Filled primaryFill={"#a66224 "} aria-hidden="true" /> Web compared to Work</div>;
        }
    else if (approach == Approaches.CompareWorkWithWeb) {
        return <div className={styles.answerLogoCompare}><BuildingMultiple24Filled primaryFill={"#a66224 "} aria-hidden="true" aria-label="Work Compared to Web Answer logo" /><Link20Filled primaryFill={"#a66224 "} /><Globe24Filled primaryFill={"#a66224 "} aria-hidden="true" /> Work compared to Web</div>;
        }
    else {
