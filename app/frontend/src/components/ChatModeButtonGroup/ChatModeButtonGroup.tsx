    ...
    <div className={`${styles.container} ${className ?? ""}`}>
      {
        ...
        featureFlags?.ENABLE_WEB_CHAT && featureFlags?.ENABLE_UNGROUNDED_CHAT ? (
          <ButtonGroup className={`${styles.buttonGroup}`} onClick={onClick} bsPrefix="ia">
            <Button className={`${defaultValue == ChatMode.WorkOnly ? styles.buttonleftactive : (styles.buttonleft ?? "")}`} size="sm" value={0} bsPrefix="ia">
              {"Work Only"}
            </Button>
            <Button
              className={`${defaultValue == ChatMode.WorkPlusWeb ? styles.buttonmiddleactive : (styles.buttonmiddle ?? "")}`}
              size="sm"
              value={1}
              bsPrefix="ia"
            >
            ...
            <Button
              className={`${defaultValue == ChatMode.Ungrounded ? styles.buttonrightactive : (styles.buttonright ?? "")}`}
              size="sm"
              value={2}
              bsPrefix="ia"
            >
              {"Generative (Ungrounded)"}
            </Button>
          </ButtonGroup>
        ...
        featureFlags?.ENABLE_WEB_CHAT && !featureFlags?.ENABLE_UNGROUNDED_CHAT ? (
          <ButtonGroup className={`${styles.buttonGroup}`} onClick={onClick} bsPrefix="ia">
            ...
            <Button
              className={`${defaultValue == ChatMode.WorkPlusWeb ? styles.buttonrightactive : (styles.buttonright ?? "")}`}
              size="sm"
              value={1}
              bsPrefix="ia"
            >
        ...
        featureFlags?.ENABLE_UNGROUNDED_CHAT && !featureFlags?.ENABLE_WEB_CHAT ? (
          ...
          <ButtonGroup className={`${styles.buttonGroup}`} onClick={onClick} bsPrefix="ia">
            <Button
              className={`${defaultValue == ChatMode.WorkOnly ? styles.buttonmiddleactive : (styles.buttonmiddle ?? "")}`}
              size="sm"
              value={0}
              bsPrefix="ia"
            >
