      ...
      >
        {approach == Approaches.ReadRetrieveRead ? (
          <span style={{ marginRight: "10px" }}>
            <BuildingMultiple20Filled primaryFill={"rgba(255, 255, 225, 1)"} />
          </span>
        ) : approach == Approaches.ChatWebRetrieveRead ? (
          <span style={{ marginRight: "10px" }}>
            <GlobeSearch20Filled primaryFill={"rgba(255, 255, 225, 1)"} />
          </span>
        ) : approach == Approaches.CompareWebWithWork ? (
          <span style={{ marginRight: "10px" }}>
            <GlobeSearch20Filled primaryFill={"rgba(255, 255, 225, 1)"} />
            <Link16Filled primaryFill={"rgba(255, 255, 225, 1)"} />
            <BuildingMultiple20Filled primaryFill={"rgba(255, 255, 225, 1)"} />
          </span>
          ...
          //else
          <div className={styles.messageungroundedheader}>
            <div className={styles.messageungroundedicon}>
              <Person20Filled primaryFill={"rgba(0, 0, 0, 0.35)"} />
            </div>
            <span className={styles.messageungroundedtext}>You</span>
          </div>
        )}
