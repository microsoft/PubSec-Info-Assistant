...
const Chat = () => {
    ...
    return (
        <main aria-label="Chat with your work data">
                    ...
                    {!lastQuestionRef.current ? (
                        <div className={styles.chatEmptyState}>
                            {activeChatMode == ChatMode.WorkOnly ? 
                                <div>
                                    <div className={styles.chatEmptyStateHeader}> 
                                        <BuildingMultipleFilled className={styles.buildingIcon} fontSize={"100px"} primaryFill={"rgba(27, 74, 239, 1)"} aria-hidden="true" aria-label="Chat with your Work Data logo" />
                                        </div>
                                    <h1 >Chat with your work data</h1>
                                </div>
                            ...
                            <span className={styles.chatEmptyObjectives}>
                                <i>Information Assistant uses AI. Check for mistakes.   </i><a className={styles.Transparency} href="https://github.com/microsoft/PubSec-Info-Assistant/blob/main/docs/transparency.md" target="_blank" rel="noopener noreferrer">Transparency Note</a>
                            </span>
                        ...
                        <div className={`${styles.chatMessageStream} ${activeAnalysisPanelTab ? styles.chatMessageStreamReduced : ""}`}>
                ...
                >
                    {activeChatMode == ChatMode.WorkPlusWeb &&
                        <div>
                            ...
                            <div className={styles.defaultApproachSwitch}>
                                ...
                                <Switch onChange={handleToggle} checked={defaultApproach == Approaches.ReadRetrieveRead} uncheckedIcon={true} checkedIcon={true} onColor="#1B4AEF" offColor="#168541" aria-label="Toggle between Web and Work data sources"/>
                    ...
                    {activeChatMode != ChatMode.Ungrounded &&
                        <SpinButton
                            ...
                            aria-label="Number of documents to retrieve from search"
                            aria-labelledby="spinButtonLabel"
                            title="Retrieve this many documents from search"
