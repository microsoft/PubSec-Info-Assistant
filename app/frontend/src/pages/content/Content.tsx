...
const Content = () => {
    ...
    const renderPivotItemHeader = (props?: IPivotItemProps, defaultRender?: (props?: IPivotItemProps) => JSX.Element | null) => {
        if (!props || !defaultRender) {
            return null;
        }
        return (
            <span tabIndex={0} role="tab" aria-label={props.headerText}>
                {defaultRender(props)}
            </span>
        );
    };
    useEffect(() => {
        // Add tabIndex to PivotItem headers
        const pivotHeaders = document.querySelectorAll('.ms-Pivot-link');
        pivotHeaders.forEach(header => {
    ...
    return (
        ...
        <div className={styles.contentArea} >
            <Pivot aria-label="Upload Files Section"  className={styles.topPivot} onLinkClick={handleLinkClick}>
                <PivotItem  headerText="Upload Files"  aria-label="Upload Files Tab" tabIndex={0}>
                    <div  className={styles.App} >
                        <div style={{ marginBottom: 'Up;20px', marginTop: '20px' }}>
                            ...
                            <span className={styles.EmptyObjectivesList}>
                                ...
                                <span className={styles.EmptyObjectivesListItem}>
                                    ...
                                    For page count maximum check documentation  <a href="https://learn.microsoft.com/en-us/azure/ai-services/document-intelligence/concept-layout?view=doc-intel-4.0.0#input-requirements"  style={{ color: '#0b62e4' }}>
                                        here</a> 
                                    </span>
                                </span>
                                <span className={styles.EmptyObjectivesListItem}>
