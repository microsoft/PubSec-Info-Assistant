...
az feature show --name AllowNetworkSecurityPerimeter --namespace Microsoft.Network --output table
...
az feature register --name AllowNetworkSecurityPerimeter --namespace Microsoft.Network
