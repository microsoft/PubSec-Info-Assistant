...
![Codespaces in vscode](../images/codespaces_open_in_vs_code_desktop.png)
...
1. In VS Code, in the Activity Bar, click the Remote Explorer icon.
 ![Alt text](../images/developing_in_a_codespaces_image_1.png)
...
3. Click **Sign in to GitHub.**
    ...
    ![Alt text](../images/developing_in_a_codespaces_image_2.png)
...
1. In VS Code, in the Activity Bar, click the Remote Explorer icon.
    ...
    ![Alt text](../images/developing_in_a_codespaces_open_in_vscode_3.png)

2. Under "GitHub Codespaces", hover over the codespace you want to develop in.

3. Click the connection icon (a plug symbol).

    ![Alt text](../images/developing_in_a_codespaces_open_in_vscode_4.png)
...
- You can see every available codespace that you have created at github.com/codespaces.
    ...
    ![Alt text](../images/developing_in_a_codespaces_open_in_vscode_2.png)
