...
class Utilities:
    ...
    def write_blob(self, output_container, content, output_filename, folder_set=""):
        ...
        blob_service_client = BlobServiceClient(
            f'https://{self.azure_blob_storage_account}.blob.core.usgovcloudapi.net/',
    ...
    def  get_blob_and_sas(self, blob_path):
        ...
        source_blob_path = f'https://{self.azure_blob_storage_account}.blob.core.usgovcloudapi.net/{blob_path}?{sas_token}'
