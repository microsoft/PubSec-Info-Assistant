...
// add scope resource for app insights
...
resource "azurerm_private_endpoint" "ampls" {
  ...
  depends_on = [ azurerm_monitor_private_link_scoped_service.ampl-ss_log_analytics, azurerm_monitor_private_link_scoped_service.ampl_ss_app_insights ]
}
