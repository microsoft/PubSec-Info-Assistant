...
resource "azurerm_key_vault_secret" "bing_api_key" {
  depends_on  = [
    azurerm_role_assignment.key_vault_rbac_infoasst, azurerm_resource_group_template_deployment.nsp_assoc_w_kv, azurerm_private_endpoint.kv_private_endpoint
  ]
  name            = "BINGSEARCH-KEY"
