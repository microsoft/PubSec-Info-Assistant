...
output "KNOWLEDGE_STORE_CONNECTION_STRING" {
  value = "ResourceId=${module.storage.storage_account_id}"
}

output "AZURE_BLOB_STORAGE_UPLOAD_CONTAINER" {
...
output "AZURE_BLOB_STORAGE_CONTAINER" {
  value = var.uploadContainerName
}
...
output "AZURE_BLOB_STORAGE_ENDPOINT" {
  value = module.storage.primary_blob_endpoint
}

output "TABLE_STORAGE_ACCOUNT_ENDPOINT" {
