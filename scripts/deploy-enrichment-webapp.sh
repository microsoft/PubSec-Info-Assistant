...
az webapp config set --name $ENRICHMENT_APPSERVICE_NAM --resource-group $RESOURCE_GROUP_NAME --startup-file "gunicorn -w 4 -k uvicorn.workers.UvicornWorker app:app"
