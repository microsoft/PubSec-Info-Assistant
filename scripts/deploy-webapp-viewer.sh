...
az webapp deploy --name $AZURE_WEBAPP_VIEWER_NAME --resource-group $RESOURCE_GROUP_NAME --type zip --src-path webappviewer.zip --async true --timeout 600000 --verbose

echo "Webapp Viewer deployed successfully"
