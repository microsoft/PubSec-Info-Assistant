...
az webapp deploy --name $AZURE_WEBAPP_NAME --resource-group $RESOURCE_GROUP_NAME --type zip --src-url "https://$AZURE_BLOB_STORAGE_ACCOUNT.blob.core.windows.net/website/webapp.zip?$sas" --async true --timeout 600000 --clean true --debug --verbose