...
export TF_VAR_mathAssistantChatGptDeploymentName=$AZURE_OPENAI_MATH_ASSISTANT_CHATGPT_DEPLOYMENT
export TF_VAR_tabularDataChatGptDeploymentName=$AZURE_OPENAI_TABULAR_DATA_ASSISTANT_CHATGPT_DEPLOYMENT
